...
Se trabaja con transacciones de tarjetas de crédito altamente desbalanceadas: 284.807 registros, de los cuales 492 corresponden a fraude. Se comparan Decision Tree, Random Forest, Gradient Boosting y dos arquitecturas Keras. En el análisis original, Random Forest alcanza el mejor F1 entre los modelos clásicos (0,9087), mientras la versión secuencial de Keras registra precision 0,9720 y recall 0,8740.
...
- `notebooks/`: notebook original y versión portable con rutas relativas.
